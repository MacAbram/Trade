 ...
 */
class Gallery extends \Gallery\Entity\Gallery implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Gallery\\Entity\\Gallery' . "\0" . 'id', '' . "\0" . 'Gallery\\Entity\\Gallery' . "\0" . 'parent', '' . "\0" . 'Gallery\\Entity\\Gallery' . "\0" . 'folder', '' . "\0" . 'Gallery\\Entity\\Gallery' . "\0" . 'created', '' . "\0" . 'Gallery\\Entity\\Gallery' . "\0" . 'visible');
        }
